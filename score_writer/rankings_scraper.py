...
with open(outputFile, 'a') as output_csv:
    fieldnames = ['TEAM_ID','TEAM_NAME', 'OVERALL', 'HOME_RECORD', 'ROAD_RECORD', 'POST_SEASON_RECORD', 'RECORD_CLOSE_GAMES', "RECORD_NORMAL_GAMES"]
    ...
    for row in tableRows:
        ...
        if(row_has_data and rankCell[0].text != "Rk"):
            ...
            writer.writerow({'TEAM_ID': team_id,'TEAM_NAME': team_name, 'OVERALL': overall, 'HOME_RECORD': home_record, 'ROAD_RECORD': road_record, "POST_SEASON_RECORD":post_season_record, "RECORD_CLOSE_GAMES":record_close_games, "RECORD_NORMAL_GAMES": record_normal_games})
