...
x_input_features = csv_dataframe.iloc[:, range(0, 10)]
y_output_data = csv_dataframe.iloc[:, [10]]
model = LogisticRegression(penalty='none',max_iter=100).fit(x_input_features, np.array(y_output_data).ravel())
